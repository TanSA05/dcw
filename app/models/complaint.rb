...
class Complaint < ActiveRecord::Base
  ...
  validate :respondent_presence

  def respondent_presence
    if respondent_if_person.blank? && respondent_if_agency.blank?
  		errors.add(:respondent_if_person, 'Please fill the respondent')
  		# errors.add(person ? :respondent_if_person : :respondent_if_agency, 'Please fill the respondent')
  	end
  end
	...
	enumerize :category, in: ["Domestic Violence", "Rape", "Sexual Assualt"]
	enumerize :respondent_if_agency, in: ["DCW","CAW","DLSA","ICC","Police"]
